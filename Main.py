...
class MyStrategys(bt.Strategy):
    ...
    def next(self):
        ...
        # Check if all indicators are showing the same position and place a trade if they
        ...
        if is_trending and not self.position_opened:
            ...
            try:
                self.api.metatrader_trades_api.update_trade(self.params.account_id, order_id,stop_loss=stop_loss, take_profit=take_profit)
                print("success T")
            except Exception as e:
            ...
            try:
                ...
                print(f"Error updating trade: {e}")
                return
        print("no such market conditions")
